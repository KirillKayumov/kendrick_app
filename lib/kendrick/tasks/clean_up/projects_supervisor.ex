defmodule Kendrick.Tasks.CleanUp.ProjectsSupervisor do
  use DynamicSupervisor

  alias Kendrick.Tasks.CleanUp.Worker
  ...
  def create_project(project) do
    DynamicSupervisor.start_child(__MODULE__, {Worker, project: project})
  end
